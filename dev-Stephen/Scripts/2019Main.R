...
ggplot(data19, aes(x = category, y = ecological_deficit_or_reserve)) + 
  geom_boxplot()+
  labs(title = "Ecological Deficit or Reserve by Category", 
       x = "Category",
       y = "Ecological Deficit Or Reserve")

ecological_df <- select(data19, category, ecological_deficit_or_reserve)
...
cat1 <- filter(data19, category == "1") 
cat2 <- filter(data19, category == "2")
cat3 <- filter(data19, category == "3")
cat4 <- filter(data19, category == "4")
...
contingency_table <- table(data19$category, data19$income_group)

category <- unique(na.omit(data19$category))
cat_comb <- combn(category, 2)

income <- unique(data19$income_group[data19$income_group != ""])
...
ggplot(data19, aes(x = income_group, y = cropland_footprint))+
  geom_boxplot()

income_crop_fp_df <- select(data19, income_group, cropland_footprint)
...
ggplot(data19, aes(x = income_group, y = cropland_capacity))+
  geom_boxplot()

income_crop_cap_df <- select(data19, income_group, cropland_capacity)
...
ggplot(data19, aes(x = income_group, y = forest_footprint))+
  geom_boxplot()

income_forest_fp_df <- select(data19, income_group, forest_footprint)
...
ggplot(data19, aes(x = income_group, y = forest_capacity))+
  geom_boxplot()

income_forest_cap_df <- select(data19, income_group, forest_capacity)
...
ggplot(data19, aes(x = income_group, y = carbon_footprint))+
  geom_boxplot()

income_carbon_fp_df <- select(data19, income_group, carbon_footprint)
...
ggplot(data19, aes(x = income_group, y = grazing_footprint))+
  geom_boxplot()

income_grazing_fp_df <- select(data19, income_group, grazing_footprint)
...
ggplot(data19, aes(x = income_group, y = grazing_capacity))+
  geom_boxplot()

income_grazing_cap_df <- select(data19, income_group, grazing_capacity)
...
ggplot(data19, aes(x = income_group, y = builtup_land_footprint))+
  geom_boxplot()

income_land_fp_df <- select(data19, income_group, builtup_land_footprint)
...
ggplot(data19, aes(x = income_group, y = builtup_land_capacity))+
  geom_boxplot()

income_land_cap_df <- select(data19, income_group, builtup_land_capacity)
...
ggplot(data19, aes(x = income_group, y = fish_footprint))+
  geom_boxplot()

income_fish_fp_df <- select(data19, income_group, fish_footprint)
income_fish_fp <- aov(fish_footprint ~ income_group, data = income_fish_fp_df, na.action = na.exclude)
summary(income_fish_fp)
#NA

ggplot(data19, aes(x = income_group, y = fish_capacity))+
  geom_boxplot()

income_fish_cap_df <- select(data19, income_group, fish_capacity)
