...
#Differences in Resource usages

#Crop
t_test_crop_df <- na.omit(crop_df)
crop_fp_t_test <- t.test(t_test_crop_df$cropland_footprint19, t_test_crop_df$cropland_footprint23, paired = TRUE)
crop_fp_t_test
...
land_fp_t_test
land_cap_t_test <- t.test(t_test_land_df$builtup_land_capacity19, t_test_land_df$builtup_land_capacity23, paired = TRUE)
land_cap_t_test
