...
footprint_features <- select(data, "country", contains("footprint"), "built_up_land")
...
data <- rename(data, eco_difference = ecological_deficit_or_reserve) #rename ecological deficit or reserve to something easier
