...
data_standardized <- as.data.frame(scale(data[-ncol(data)][, sapply(data, is.numeric)])) #standardize everything but the target
...
data_standardized <- mutate(data_standardized, is_sustainable = data$is_sustainable)
data_standardized
```
